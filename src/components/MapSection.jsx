...
const labels = {
  pt: {
    ...
    items: [
      { icon: '🚇', label: 'Alameda (Linha Amarela)', value: '3 min a pé' },
    ...
    open: 'Ver mapa maior',
    note: 'Estação de Metro Alameda (Linha Amarela) — a apenas 3 minutos a pé do apartamento. Acesso direto ao centro da cidade sem necessidade de carro.',
  ...
  en: {
    ...
    address_detail: 'Intendente, Lisboa, Portugal',
    items: [
      { icon: '🚇', label: 'Alameda (Yellow Line)', value: '3 min walk' },
    ...
    note: 'Alameda Metro Station (Yellow Line) — just 3 minutes\' walk from the apartment. Direct access to the city centre with no need for a car.',
  ...
  fr: {
    ...
    address_detail: 'Intendente, Lisboa, Portugal',
    items: [
      { icon: '🚇', label: 'Alameda (Ligne Jaune)', value: '3 min à pied' },
    ...
    note: 'Station de Métro Alameda (Ligne Jaune) — à seulement 3 minutes à pied de l\'appartement. Accès direct au centre-ville sans besoin de voiture.',
  ...
  es: {
    ...
    address_detail: 'Intendente, Lisboa, Portugal',
    items: [
      { icon: '🚇', label: 'Alameda (Línea Amarilla)', value: '3 min caminando' },
    ...
    note: 'Estación de Metro Alameda (Línea Amarilla) — a solo 3 minutos a pie del apartamento. Acceso directo al centro de la ciudad sin necesidad de coche.',
  ...
  de: {
    ...
    address_detail: 'Intendente, Lisboa, Portugal',
    items: [
      { icon: '🚇', label: 'Alameda (Gelbe Linie)', value: '3 min zu Fuß' },
    ...
    note: 'U-Bahn-Station Alameda (Gelbe Linie) — nur 3 Gehminuten von der Wohnung entfernt. Direkter Zugang zum Stadtzentrum ohne Auto.',
  ...
  it: {
    ...
    items: [
      { icon: '🚇', label: 'Alameda (Linea Gialla)', value: '3 min a piedi' },
    ...
    note: 'Stazione Metro Alameda (Linea Gialla) — a soli 3 minuti a piedi dall\'appartamento. Accesso diretto al centro città senza bisogno di auto.',
    photo_hint: 'Foto Metro / Zona',
  ...
  ja: {
    ...
    items: [
      { icon: '🚇', label: 'オディヴェラス（イエローライン）', value: '徒歩3分' },
      { icon: '✈️', label: '空港', value: '車で20分' },
      { icon: '🚌', label: 'バス', value: '周辺に複数' },
      { icon: '🏖️', label: 'テージョ川', value: '徒歩10分' },
    ],
    open: '大きな地図を見る',
    note: 'オディヴェラス地下鉄駅（イエローライン）— アパートから徒歩わずか3分。車なしで市内中心部へ直通アクセス。',
