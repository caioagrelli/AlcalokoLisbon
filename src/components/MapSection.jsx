...
const labels = {
  pt: {
    ...
    open: 'Ver mapa maior',
    note: 'Estação de Metro Alameda (Linha Vermelha) — a apenas 2 minutos a pé do apartamento. Acesso direto ao centro da cidade sem necessidade de carro.',
  ...
  en: {
    ...
    note: 'Alameda Metro Station (Red Line) — just 2 minutes\' walk from the apartment. Direct access to the city centre with no need for a car.',
  ...
  fr: {
    ...
    note: 'Station de Métro Alameda (Ligne Rouge) — à seulement 2 minutes à pied de l\'appartement. Accès direct au centre-ville sans besoin de voiture.',
  ...
  es: {
    ...
    note: 'Estación de Metro Alameda (Línea Roja) — a solo 2 minutos a pie del apartamento. Acceso directo al centro de la ciudad sin necesidad de coche.',
  ...
  de: {
    ...
    note: 'U-Bahn-Station Alameda (Rote Linie) — nur 2 Gehminuten von der Wohnung entfernt. Direkter Zugang zum Stadtzentrum ohne Auto.',
  ...
  it: {
    ...
    note: 'Stazione Metro Alameda (Linea Rossa) — a soli 2 minuti a piedi dall\'appartamento. Accesso diretto al centro città senza bisogno di auto.',
    photo_hint: 'Foto Metro / Zona',
  ...
  ja: {
    ...
    open: '大きな地図を見る',
    note: 'アラメダ地下鉄駅（レッドライン）— アパートから徒歩わずか2分。車なしで市内中心部へ直通アクセス。',
