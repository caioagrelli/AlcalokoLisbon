 ...
 * ════════════════════════════════════════════════════════════════
 */
const METRO_NOTE = null; // movido para labels por idioma
...
const labels = {
  pt: {
    ...
    items: [
      { icon: '🚇', label: 'Alameda (Linha Vermelha)', value: '2 min a pé' },
      { icon: '✈️', label: 'Aeroporto', value: '20 min de carro' },
      { icon: '🚌', label: 'Autocarros', value: 'Nas redondezas' },
      { icon: '🏖️', label: 'Rio Tejo', value: '10 min a pé' },
    ],
    open: 'Ver mapa maior',
    note: 'Estação Alameda (Linha Vermelha): fica a apenas 2 minutos a pé do nosso apartamento. São só 9 paragens até ao Aeroporto. A forma mais rápida, prática e económica de chegar ou sair!',
  ...
  en: {
    ...
    address_detail: 'Intendente, Lisboa, Portugal',
    items: [
      { icon: '🚇', label: 'Alameda (Red Line)', value: '2 min walk' },
      { icon: '✈️', label: 'Airport', value: '20 min by car' },
      { icon: '🚌', label: 'Bus', value: 'Nearby' },
      { icon: '🏖️', label: 'Tagus River', value: '10 min walk' },
    ],
    open: 'View larger map',
    note: 'Alameda Station (Red Line): just 2 minutes\' walk from our apartment. Only 9 stops to the Airport. The fastest, most practical and affordable way to arrive or leave!',
  ...
  fr: {
    ...
    address_detail: 'Intendente, Lisboa, Portugal',
    items: [
      { icon: '🚇', label: 'Alameda (Ligne Rouge)', value: '2 min à pied' },
      { icon: '✈️', label: 'Aéroport', value: '20 min en voiture' },
      { icon: '🚌', label: 'Bus', value: 'À proximité' },
      { icon: '🏖️', label: 'Fleuve Tage', value: '10 min à pied' },
    ],
    open: 'Voir la carte agrandie',
    note: 'Station Alameda (Ligne Rouge) : à seulement 2 minutes à pied de notre appartement. Seulement 9 arrêts jusqu\'à l\'Aéroport. Le moyen le plus rapide, pratique et économique d\'arriver ou de partir !',
  ...
  es: {
    ...
    address_detail: 'Intendente, Lisboa, Portugal',
    items: [
      { icon: '🚇', label: 'Alameda (Línea Roja)', value: '2 min caminando' },
      { icon: '✈️', label: 'Aeropuerto', value: '20 min en coche' },
      { icon: '🚌', label: 'Autobús', value: 'En los alrededores' },
      { icon: '🏖️', label: 'Río Tajo', value: '10 min caminando' },
    ],
    open: 'Ver mapa más grande',
    note: 'Estación Alameda (Línea Roja): a solo 2 minutos a pie de nuestro apartamento. Solo 9 paradas hasta el Aeropuerto. ¡La forma más rápida, práctica y económica de llegar o salir!',
  ...
  de: {
    ...
    address_detail: 'Intendente, Lisboa, Portugal',
    items: [
      { icon: '🚇', label: 'Alameda (Rote Linie)', value: '2 min zu Fuß' },
      { icon: '✈️', label: 'Flughafen', value: '20 min mit dem Auto' },
      { icon: '🚌', label: 'Bus', value: 'In der Nähe' },
      { icon: '🏖️', label: 'Fluss Tejo', value: '10 min zu Fuß' },
    ],
    open: 'Größere Karte anzeigen',
    note: 'Station Alameda (Rote Linie): nur 2 Gehminuten von unserer Wohnung entfernt. Nur 9 Stationen bis zum Flughafen. Die schnellste, praktischste und günstigste Art anzureisen oder abzureisen!',
  ...
  it: {
    ...
    items: [
      { icon: '🚇', label: 'Alameda (Linea Rossa)', value: '2 min a piedi' },
      { icon: '✈️', label: 'Aeroporto', value: '20 min in auto' },
      { icon: '🚌', label: 'Autobus', value: 'Nelle vicinanze' },
      { icon: '🏖️', label: 'Fiume Tago', value: '10 min a piedi' },
    ],
    open: 'Vedi mappa più grande',
    note: 'Stazione Alameda (Linea Rossa): a soli 2 minuti a piedi dal nostro appartamento. Solo 9 fermate fino all\'Aeroporto. Il modo più rapido, pratico ed economico per arrivare o partire!',
    photo_hint: 'Foto Metro / Zona',
  ...
  ja: {
    ...
    items: [
      { icon: '🚇', label: 'アラメダ（レッドライン）', value: '徒歩2分' },
      { icon: '✈️', label: '空港', value: '車で20分' },
      { icon: '🚌', label: 'バス', value: '周辺に複数' },
      { icon: '🏖️', label: 'テージョ川', value: '徒歩10分' },
    ],
    open: '大きな地図を見る',
    note: 'アラメダ駅（レッドライン）：アパートから徒歩わずか2分。空港まで9駅だけ。最速・最便利・最安値の移動手段です！',
      ...
      <div className="container">
        ...
        {lbl.note && (
          ...
          >
            ...
            <p className="map-section__note-text">{lbl.note}</p>
          </motion.div>
        )}
