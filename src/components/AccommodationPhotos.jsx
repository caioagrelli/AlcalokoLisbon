...
const photos = [
  ...
  { src: pub('/photos/rooms/room1/r1_2.png'), alt: 'Vermelho', span: 'normal', room: 1 },
  { src: pub('/photos/rooms/room1/r1_3.png'), alt: 'Vermelho', span: 'normal', room: 1 },
  { src: pub('/photos/rooms/room1/r1_4.png'), alt: 'Vermelho', span: 'normal', room: 1 },
  { src: pub('/photos/rooms/room1/r1_5.png'), alt: 'Vermelho', span: 'large',  room: 1 },
  { src: pub('/photos/rooms/room1/r1_6.png'), alt: 'Vermelho', span: 'normal', room: 1 },
  { src: pub('/photos/rooms/room1/r1_7.png'), alt: 'Vermelho', span: 'normal', room: 1 },

  // ── Quarto 2 (room: 2) ──────────────────────────────
  { src: pub('/photos/rooms/room2/r2_1.png'), alt: 'Verde', span: 'large',  room: 2 },
  { src: pub('/photos/rooms/room2/r2_2.png'), alt: 'Verde', span: 'normal', room: 2 },
  { src: pub('/photos/rooms/room2/r2_3.png'), alt: 'Verde', span: 'normal', room: 2 },
  { src: pub('/photos/rooms/room2/r2_4.png'), alt: 'Verde', span: 'normal', room: 2 },
  { src: pub('/photos/rooms/room2/r2_5.png'), alt: 'Verde', span: 'large',  room: 2 },
  { src: pub('/photos/rooms/room2/r2_6.png'), alt: 'Verde', span: 'normal', room: 2 },
  { src: pub('/photos/rooms/room2/r2_7.png'), alt: 'Verde', span: 'normal', room: 2 },
  { src: pub('/photos/rooms/room2/r2_8.png'), alt: 'Verde', span: 'normal', room: 2 },

  // ── Quarto 3 (room: 3) ──────────────────────────────
  { src: pub('/photos/rooms/room3/r3_1.png'), alt: 'Azul', span: 'large',  room: 3 },
  { src: pub('/photos/rooms/room3/r3_2.png'), alt: 'Azul', span: 'normal', room: 3 },
  { src: pub('/photos/rooms/room3/r3_3.png'), alt: 'Azul', span: 'normal', room: 3 },
  { src: pub('/photos/rooms/room3/r3_4.png'), alt: 'Azul', span: 'normal', room: 3 },
  { src: pub('/photos/rooms/room3/r3_5.png'), alt: 'Azul', span: 'large',  room: 3 },
  { src: pub('/photos/rooms/room3/r3_6.png'), alt: 'Azul', span: 'normal', room: 3 },
  { src: pub('/photos/rooms/room3/r3_7.png'), alt: 'Azul', span: 'normal', room: 3 },
  { src: pub('/photos/rooms/room3/r3_8.png'), alt: 'Azul', span: 'normal', room: 3 },
];

const i18n = {
  pt: {
    title: 'Fotos da', subtitle: 'Acomodação',
    all: 'Todos', rooms: ['Vermelho', 'Verde', 'Azul'],
  ...
  fr: {
    ...
    all: 'Tout', rooms: ['Rouge', 'Vert', 'Bleu'],
  ...
  es: {
    ...
    all: 'Todo', rooms: ['Rojo', 'Verde', 'Azul'],
  ...
  it: {
    ...
    all: 'Tutti', rooms: ['Rosso', 'Verde', 'Blu'],
