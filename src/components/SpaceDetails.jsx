...
const content = {
  pt: {
    ...
    highlights: [
      ...
      { icon: '🚇', title: 'Metro Alameda', desc: 'Estação Alameda (Linha Vermelha) a apenas 2 minutos a pé. Acesso direto ao centro sem carro.' },
    ...
    rules: [
      ...
      { icon: '🐾', label: 'Animais de estimação', value: 'Pequeno porte permitido' },
    ],
  ...
  en: {
    ...
    highlights: [
      ...
      { icon: '🚇', title: 'Alameda Metro', desc: 'Alameda station (Red Line) just 2 minutes\' walk. Direct access to the city centre, no car needed.' },
    ...
    rules: [
      ...
      { icon: '🐾', label: 'Pets', value: 'Small pets allowed' },
    ],
  ...
  fr: {
    ...
    highlights: [
      ...
      { icon: '🚇', title: 'Métro Alameda', desc: 'Station Alameda (Ligne Rouge) à 2 minutes à pied. Accès direct au centre-ville sans voiture.' },
    ...
    rules: [
      ...
      { icon: '🐾', label: 'Animaux de compagnie', value: 'Petits animaux acceptés' },
    ],
  ...
  es: {
    ...
    highlights: [
      ...
      { icon: '🚇', title: 'Metro Alameda', desc: 'Estación Alameda (Línea Roja) a solo 2 minutos a pie. Acceso directo al centro sin coche.' },
    ...
    rules: [
      ...
      { icon: '🐾', label: 'Mascotas', value: 'Animales pequeños permitidos' },
    ],
    tour_title: 'Tour Guiado por Lisboa',
  ...
  de: {
    ...
    highlights: [
      ...
      { icon: '🚇', title: 'U-Bahn Alameda', desc: 'Station Alameda (Rote Linie) nur 2 Gehminuten entfernt. Direkter Zugang zum Zentrum ohne Auto.' },
    ...
    rules: [
      ...
      { icon: '🐾', label: 'Haustiere', value: 'Kleine Haustiere erlaubt' },
    ],
  ...
  it: {
    ...
    highlights: [
      ...
      { icon: '🚇', title: 'Metro Alameda', desc: 'Stazione Alameda (Linea Rossa) a soli 2 minuti a piedi. Accesso diretto al centro senza auto.' },
    ...
    rules: [
      ...
      { icon: '🐾', label: 'Animali domestici', value: 'Animali piccoli ammessi' },
    ],
  ...
  ja: {
    ...
    highlights: [
      ...
      { icon: '🚇', title: 'アラメダ駅', desc: 'アラメダ駅（レッドライン）は徒歩2分。車不要で市内中心部へ直通。' },
